...
class Inquiry(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='問い合わせユーザー')
...
class Coupon(models.Model):
    ...
    discount_value = models.DecimalField(max_digits=12, decimal_places=2, verbose_name='割引量')
    available_stores = models.ManyToManyField(Store, verbose_name='利用可能店舗', blank=True)
